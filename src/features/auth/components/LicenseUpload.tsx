...
type LicenseFormProps = {
  onSubmit: (licenseData: { frontPhoto: File; backPhoto: File }) => void;
  onBack: () => void;
};

const LicenseForm: React.FC<LicenseFormProps> = ({ onSubmit, onBack }) => {
  ...
  const renderPhotoBox = (
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="relative border-2 border-dashed border-gray-300 rounded-lg h-70 flex items-center justify-center overflow-hidden">
        {file ? (
          <>
            <img
  ...
  return (
    ...
    >
      <p>Please select clear photos of your license</p>
